...
| MySQL Data Cleaning & Transformation (MySQL) | [Go to Section](#-mysql-data-cleaning--transformation) |
| Business Intelligence Layer (Power BI) | [Go to Section](#-business-intelligence-layer-power-bi) |
...
- **Sales Overview**
Provides a high-level view of total revenue, gross income, quantity sold, and ratings, along with monthly and city-wise revenue trends.

- **Product Performance**
Analyzes product line sales, gross margins, and customer engagement to highlight top-performing and underperforming product categories.

- **Customer Insights**
Breaks down revenue and purchasing behavior by customer type, gender, and payment method to understand key customer segments.

- **Time Insights**
Identifies the best month, day, and hour while revealing sales patterns across days, hours, and time-of-day to uncover peak shopping periods.
...
<br> <img src="Images/Time_Insights.png" width="450"/>
